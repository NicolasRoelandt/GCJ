...
//        long hash = computeHash("BigBoss");
//        System.out.println(computeResult(4294967296L, 5));
        System.out.println(computeHash("(k_rm{$"));


//        char[] hashResult = {150, 0, 19, 29, 24, 4};
//        char[] hashResult = {148, 61, 49, 59, 54, 35};
  char[] hashResult = {4, 24, 62, 19, 29, 24, 4};
        char[] result = hashResult;
